...
public class AFKSessionSummary : MonoBehaviour
{
    ...
    public void BeginSession()
    {
        ...
        // --------------------------------------------------------------------
        // 🔗 [SERVER HOOK] Notify backend that session started
        // --------------------------------------------------------------------
        /*
    ...
    // ------------------------------------------------------------------------
    // ⏹️ End a session and show summary
    // ------------------------------------------------------------------------
    public void EndSession()
    {
        ...
        // --------------------------------------------------------------------
        // 🔗 [SERVER HOOK] Send session summary to backend
        // --------------------------------------------------------------------
        /*
    ...
    // ------------------------------------------------------------------------
    // 📴 Auto-save when minimized or closed
    // ------------------------------------------------------------------------
    ...
    // ------------------------------------------------------------------------
    // 🧩 [OPTIONAL STRUCTS FOR BACKEND COMMUNICATION]
    // ------------------------------------------------------------------------
    [Serializable]
    ...
    // ------------------------------------------------------------------------
    // 💬 [STUB FUNCTIONS] – for future online backend
    // ------------------------------------------------------------------------
    /*
    private void SendSessionStartToServer(AFKSessionStartData data)
    {
        ...
        // or REST:
        // StartCoroutine(ServerAPI.Post("/afk/start", data));
    }
    ...
    private void SendSessionEndToServer(AFKSessionEndData data)
    {
        ...
        // or REST:
        // StartCoroutine(ServerAPI.Post("/afk/end", data));
    }
    */
}
