...
/// <summary>
/// Unified PlayerManager - SINGLE SOURCE OF TRUTH for player state
/// Consolidates player progression, stats, gear, and currency management
/// </summary>
public class PlayerManager : MonoBehaviour
{
    ...
    public bool SpendQuantumShard(int amount = 1)
    {
    ...
    public int TotalQuantumShards => QuantumShards;
}
